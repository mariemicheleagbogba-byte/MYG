...
const CALENDLY_URL = 'https://calendly.com/mygbeautyroom';
...
export default function App() {
  ...
  const handleCancelBooking = (bookingId: string) => {
    ...
    setBookings(updated);
    try {
      localStorage.setItem('myg_bookings', JSON.stringify(updated));
    } catch (e) {
  ...
  const handleSelectOptionToBook = (_category: string, _option: ServiceOption) => {
    openCalendly();
  };
          ...
          <AnimatePresence mode="wait">
            {currentView === 'home' && (
              ...
              >
                ...
                <FooterAction onOpenBooking={openCalendly} />
              </motion.div>
            )}
