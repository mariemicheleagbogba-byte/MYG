      ...
      <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col cursor-pointer" onClick={() => handleNavClick("home")}>
            <span className="font-sans font-bold text-xl tracking-tighter leading-none text-black">
              {COMPANY_INFO.name}
            </span>
            <span className="text-[7.5px] font-sans font-semibold text-gray-400 uppercase tracking-[0.25em] -mt-0.5">
              BEAUTY ROOM
            </span>
          </div>
        </div>
              ...
              <div>
                <div className="flex items-center justify-between pb-6 border-b border-gray-100">
                  <div className="flex flex-col">
                    <span className="text-xl font-sans font-bold tracking-tighter text-black">
                      {COMPANY_INFO.name}
                    </span>
                    <span className="text-[8px] font-semibold text-gray-400 tracking-[0.2em] uppercase">
                      BEAUTY ROOM
                    </span>
                  </div>
                  <button 
